    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/testimonials') ?>">نظرات مشتریان</a>
            </li>
            <li class="active">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="<?= admin_uri('/testimonials/edit/' . $data['testimonial']->id) ?>"
                                  method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="عنوان" name="title" id="title"
                                           value="<?= $data['testimonial']->title ?>" required>
                                    <?= error('title') ?>
                                </div>

                                <div class="col-md-6">
                                    <label for="client_name">نام مشتری</label>
                                    <input type="text" class="form-control" placeholder="نام مشتری" name="client_name"
                                           id="client_name"
                                           value="<?= $data['testimonial']->client_name ?>" required>
                                    <?= error('client_name') ?>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="client_photo">تصویر مشتری</label>
                                    <input type="file" class="form-control"
                                           name="client_photo" id="client_photo">
                                    <?= error('client_photo') ?>
                                </div>

                                <div class="col-md-6">
                                    <label for="client_job_title">عنوان شغلی مشتری</label>
                                    <input type="text" class="form-control" placeholder="عنوان شغلی مشتری"
                                           name="client_job_title"
                                           id="client_job_title"
                                           value="<?= $data['testimonial']->client_job_title ?>" required>
                                    <?= error('client_job_title') ?>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea cols="10" rows="5" class="form-control" placeholder="توضیحات"
                                              name="description"
                                              id="description"
                                              required><?= $data['testimonial']->description ?></textarea>
                                    <?= error('description') ?>
                                </div>
                                ...
                                <div class="col-md-1"
                                    ...
                                    <a href="<?= admin_uri('/testimonials') ?>" class="btn btn-danger">بازگشت</a>
                                </div>
