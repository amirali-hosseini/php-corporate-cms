                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="<?= admin_uri('/testimonials/create') ?>" method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control"
                                           ...
                                           value="<?= old('client_photo') ?>" required>
                                    <?= error('client_photo') ?>
                                </div>

                                <div class="col-md-6">
                                    <label for="client_job_title">عنوان شغلی مشتری</label>
                                    <input type="text" class="form-control" placeholder="عنوان شغلی مشتری" name="client_job_title"
                                           id="client_job_title"
                                           value="<?= old('client_job_title') ?>" required>
