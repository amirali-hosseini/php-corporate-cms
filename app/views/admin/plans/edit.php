    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/plans') ?>">پلن ها</a>
            </li>
            <li class="active">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="<?= admin_uri('/plans/edit/' . $data['plan']->id) ?>" method="post">

                                <div class="col-md-6">
                                    <label for="title">عنوان</label>
                                    <input type="text" class="form-control" placeholder="عنوان" name="title" id="title"
                                           value="<?= $data['plan']->title ?>" required>
                                    <?= error('title') ?>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" placeholder="قیمت" name="price"
                                           id="price"
                                           value="<?= $data['plan']->price ?>" required>
                                    <?= error('price') ?>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label for="items">توضیحات ( آیتم ها را با slash (/) از یکدیگر جدا کنید )</label>
                                    <textarea class="form-control" placeholder="توضیحات"
                                              name="items" id="items" required><?= $data['plan']->items ?></textarea>
                                    <?= error('items') ?>
                                </div>
                                ...
                                <div class="col-md-1"
                                    ...
                                    <a href="<?= admin_uri('/plans') ?>" class="btn btn-danger">بازگشت</a>
                                </div>
