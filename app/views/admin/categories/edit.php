    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/articles') ?>">دسته بندی ها</a>
            </li>
            <li class="active">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="<?= admin_uri('/categories/edit/' . $data['category']->id) ?>" method="post">
                                ...
                                <div class="col-md-1"
                                    ...
                                    <a href="<?= admin_uri('/categories') ?>" class="btn btn-danger">بازگشت</a>
                                </div>
