        ...
        <div class="main-content">
            ...
            <ol class="breadcrumb bc-3">
                ...
                <li>
                    ...
                    <a href="<?= admin_uri('/articles') ?>">اعضا</a>
                </li>
                <li class="active">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <form action="<?= admin_uri('/members/edit/' . $data['member']->id) ?>" method="post" enctype="multipart/form-data">

                                    <div class="col-md-6">
                                        <label for="name">نام</label>
                                        <input type="text" class="form-control" placeholder="عنوان" name="name" id="name"
                                            value="<?= $data['member']->name ?>" required>
                                        <?= error('name') ?>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="job_title">عنوان شغلی</label>
                                        <input type="text" class="form-control" placeholder="عنوان شغلی" name="job_title"
                                            id="job_title"
                                            value="<?= $data['member']->job_title ?>" required>
                                        <?= error('job_title') ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control" placeholder="پروفایل لینکدین"
                                            name="linkedin" id="linkedin"
                                            value="<?= $data['member']->linkedin ?>" required>
                                        <?= error('linkedin') ?>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="facebook">فیسبوک</label>
                                        <input type="url" class="form-control" placeholder="پروفایل فیسبوک" name="facebook"
                                            id="facebook"
                                            value="<?= $data['member']->facebook ?>" required>
                                        <?= error('facebook') ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control" placeholder="پروفایل توییتر"
                                            name="twitter" id="twitter"
                                            value="<?= $data['member']->twitter ?>" required>
                                        <?= error('twitter') ?>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="instagram">اینستاگرام</label>
                                        <input type="url" class="form-control" placeholder="پروفایل اینستاگرام"
                                            name="instagram"
                                            id="instagram"
                                            value="<?= $data['member']->instagram ?>" required>
                                        <?= error('instagram') ?>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" class="form-control" placeholder="پروفایل"
                                            name="profile"
                                            id="profile">
                                        <?= error('profile') ?>
                                    </div>
                                    ...
                                    <div class="col-md-1"
                                        ...
                                        <a href="<?= admin_uri('/members') ?>" class="btn btn-danger">بازگشت</a>
                                    </div>
