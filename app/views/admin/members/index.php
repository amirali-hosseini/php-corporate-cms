    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/members') ?>">اعضا</a>
            </li>
            <li class="active">
        ...
        <div style="display: flex;align-items: center;justify-content: space-between">
            ...
            <a href="<?= admin_uri('/members/create') ?>" class="btn btn-success btn-sm btn-icon icon-left">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <?php foreach ($data['members'] as $member) {
                ...
                <tr>
                    ...
                    <td><a target="_blank"
                           href="<?= asset('/images/team/' . $member->profile) ?>">مشاهده</a></td>
                    <td><?= $member->name ?></td>
                    <td><?= $member->job_title ?></td>
                    <td><a href="<?= $member->linkedin ?>" target="_blank">مشاهده</a></td>
                    <td><a href="<?= $member->facebook ?>" target="_blank">مشاهده</a></td>
                    <td><a href="<?= $member->twitter ?>" target="_blank">مشاهده</a></td>
                    <td><a href="<?= $member->instagram ?>" target="_blank">مشاهده</a></td>
                    <td><?= date('Y-m-d', strtotime($member->created_at)) ?></td>
                    <td>
                        <a href="<?= admin_uri('/members/edit/' . $member->id) ?>"
                           class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="entypo-cancel"></i>
                            ویرایش
                        </a>

                        <a href="<?= admin_uri('/members/delete/' . $member->id) ?>"
