    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/subscribers') ?>">مشترکین</a>
            </li>
            <li class="active">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <?php foreach ($data['subscribers'] as $subscriber) {
                ...
                <tr>
                    ...
                    <td class="<?= $subscriber->status ? 'text-success' : 'text-danger' ?>"><?= $subscriber->status ? 'فعال' : 'غیرفعال' ?></td>
                    <td><?= date('Y-m-d', strtotime($subscriber->created_at)) ?></td>
                    <td>
                        <a href="<?= admin_uri('/subscribers/status/' . $subscriber->id) ?>"
                           class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="entypo-pencil"></i>
                            ویرایش وضعیت
                        </a>

                        <a href="<?= admin_uri('/subscribers/delete/' . $subscriber->id) ?>"
