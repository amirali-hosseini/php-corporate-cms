...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div style="display: flex;align-items: center;justify-content: space-between">
            ...
            <a href="<?= admin_uri('/articles/create') ?>" class="btn btn-success btn-sm btn-icon icon-left">
        ...
        <table class="table table-bordered table-striped datatable" id="table-2">
            ...
            <?php foreach ($data['articles'] as $article) {
                ...
                <tr>
                    ...
                    <td><?= $article->title ?></td>
                    <td><?= $article->slug ?></td>
                    <td class="<?= $article->is_publish ? 'text-success' : 'text-warning' ?>"><?= $article->is_publish ? 'منتشر شده' : 'پیش نویس' ?></td>
                    <td><?= date('Y-m-d', strtotime($article->created_at)) ?></td>
                    <td>
                        <a href="<?= admin_uri('/articles/edit/' . $article->id) ?>"
                           class="btn btn-default btn-sm btn-icon icon-left">
                            <i class="entypo-pencil"></i>
                            ویرایش
                        </a>

                        <a href="<?= admin_uri('/articles/delete/' . $article->id) ?>"
