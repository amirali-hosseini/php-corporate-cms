    ...
    <div class="main-content">
        ...
        <ol class="breadcrumb bc-3">
            ...
            <li>
                ...
                <a href="<?= admin_uri('/settings') ?>">تنظیمات</a>
            </li>
            <li class="active">
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <form action="<?= admin_uri('/settings/edit/' . $data['setting']->id) ?>" method="post">

                                <div class="col-md-6">
                                    <label for="key">کلید</label>
                                    <input type="text" class="form-control" placeholder="کلید" id="key"
                                           value="<?= $data['setting']->key ?>" readonly>
                                </div>

                                <div class="col-md-6">
                                    <label for="name">نام</label>
                                    <input type="text" class="form-control" placeholder="نام" id="name" name="name"
                                           value="<?= $data['setting']->name ?>" required>
                                    <?= error('name') ?>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="مقدار" id="value" name="value"
                                           value="<?= $data['setting']->value ?>" required>
                                    <?= error('value') ?>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label for="descripton">توضیحات</label>
                                    <textarea cols="10" rows="5" class="form-control" placeholder="مقدار" id="descripton"
                                              name="description"
                                              required><?= $data['setting']->description ?></textarea>
                                    <?= error('description') ?>
                                </div>
                                ...
                                <div class="col-md-1"
                                    ...
                                    <a href="<?= admin_uri('/settings') ?>" class="btn btn-danger">بازگشت</a>
                                </div>
